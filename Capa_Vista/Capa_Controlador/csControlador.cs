...
namespace Capa_Controlador
{
    public class clscontrolador
    {
        ...
        public bool InsertHabitacion(string _nomb, string _cons, string _area, string _camp, string _stat)
        {
            using (con)
            {
                ...
                #region Query
                String query = @"INSERT INTO hotelsancarlos(idHabitacion, idTipoHabitacion, idTipoCama, precio, estatus) VALUE(?,?,?,?,?);";
                #endregion
                ...
                cmd.Parameters.Add("@estatus", OdbcType.VarChar).Value = _stat;
